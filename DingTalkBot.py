...
pipinao_webhook = sys.argv[1]
pipinao_secret = sys.argv[2]

# 实例化DingtalkChatbot
pipinao = DingtalkChatbot(pipinao_webhook, secret=pipinao_secret)

# 发送消息
pipinao.send_markdown(title="今天天气", text=md_message, is_at_all=False)
