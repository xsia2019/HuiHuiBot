...
huihui_webhook = sys.argv[1]
huihui_secret = sys.argv[2]

# 实例化DingtalkChatbot
huihui = DingtalkChatbot(huihui_webhook, secret=huihui_secret)

# 发送消息
huihui.send_markdown(title="今天天气", text=md_message, is_at_all=False)
